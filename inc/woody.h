...
#define PAYLOAD_OFFSET_KEY 0x2b
#define PAYLOAD_OFFSET_KEY_LEN 0x30

#define PAYLOAD_OFFSET_DATA 0x37
#define PAYLOAD_OFFSET_DATA_LEN 0x3c

#define PAYLOAD_OFFSET_DECRYPT_FN 0x48
#define PAYLOAD_OFFSET_OG_ENTRY 0x4d
